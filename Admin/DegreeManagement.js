...
function validation_form1(){
    var degreeType = document.getElementById("typeD").value;
    var degreeCode=document.getElementById("foreign_degree_code").value;
    var titleAbreviation=document.getElementById("degree_ftitle_ab").value;
    var degreeTitle=document.getElementById("foreign_degree_title").value;
    ...
    if(degreeType=="" || degreeCode=="" || titleAbreviation=="" || faculty==""||duration==""||university==""||country=="") {
...
function validation_form2() {
    ...
    var titleab=document.getElementById("course_title_ab").value;
    var fac=document.getElementById("faculty_f").value;
    var dura=document.getElementById("duration_f").value;
    var uni=document.getElementById("university_f").value;
    var countryy=document.getElementById("country_f").value;

    if(courseCode=""||countryy==""||courseTitle==""||titleab==""||fac==""||dura==""||uni==""){
...
function validation_form3() {
    ...
    var minimumPass=document.getElementById("minimum").value;
    var english=document.getElementById("english").value;
    var math=document.getElementById("mathematics").value;
    if(minimumPass==""||english==""||math==""){
        alert("Please check whether all fields are filled");
        return false;
