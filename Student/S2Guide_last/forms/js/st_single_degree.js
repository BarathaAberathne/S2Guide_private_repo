...
function loadDataFromDB(data)
{
    ...
    for(var i=0; i<keys.length; i++)
    {
        ...
        if((faculty == 'Computing') && (type == 'Local Degree')){
        ...
        if((faculty == 'Computing') && (type == 'Foreign Degree')){
        ...
        if((faculty == 'Business') && (type == 'Local Degree')){
        ...
        if((faculty == 'Business') && (type == 'Foreign Degree')){
        ...
        if((faculty == 'Engineering') && (type == 'Local Degree')){
        ...
        if((faculty == 'Engineering') && (type == 'Foreign Degree')){
        ...
        if((faculty == 'Humanities and Sciences') && (type == 'Local Degree')){
        ...
        if((faculty == 'Humanities and Sciences') && (type == 'Foreign Degree')){
        ...
        if((faculty == 'Architecture') && (type == 'Foreign Degree')){
        ...
        if((faculty == 'Hospitality and Cookery') && (type == 'Foreign Degree')){
...
function view_data_f(obj) {
    ...
    document.getElementById('ftype_label').innerHTML = typess;
