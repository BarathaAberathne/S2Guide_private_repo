(function () {
  ...
  databaseRef.once("value").then(function (snapshot) {
    ...
    function displayResult() {
      ...
      score.append("You scored for Engineering faculty: " + (tot_eng) + "Points </br>");
      score.append("You scored for Business faculty: " + (tot_bm) + "Points </br>");
      score.append("You scored for Architecture faculty: " + (tot_arch) + "Points </br>");
      score.append("You scored for Hospitality and Cookery faculty: " + (tot_hc) + "Points </br> ");
      score.append("You scored for Humanity and Sciences faculty: " + (tot_hs) + "Points </br> ");
